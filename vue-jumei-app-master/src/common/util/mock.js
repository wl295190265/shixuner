...
export default Mock.mock('/api/data', (req, res) => {
  ...
  return {
	...
	"id":6,
	"dianpu":"鸿翔旗舰店",
	"img":"http://p12.jmstatic.com/html_editor/201702/24/14879178041530.jpg",
	"good":"美国•【诠释唇色】魅可（MAC）时尚唇膏3g，爆款色号上架，诱惑无法抗拒",
	"types":"Flat out fabulous（哑光玫红）",
	"count":1,
	 'nowPrice': 148,
     'oldPrice': 170,
	"sale":0,
	...
	"id":9,
	"dianpu":"光云攻防",
	"img":"http://images2.jumei.com/user_avatar/102/653/102653606-64-1505009489.jpg?1505009489",
	"good":"法国•圣罗兰黑管镜面唇釉5.5ml",
	"types":"Flat out fabulous（哑光玫红）",
	"count":1,
	 'nowPrice': 148,
     'oldPrice': 170,
