<template lang="html">
	<div class="nav-wrapper" ref="navWrapper" style="min-height: 10rem;"> 
  <ul  class="online-wrap" >
    <li class="deal-item border-line" v-for="(good, index) in list"
    ...
    <li v-show="load" style="height:20px">加载中...</li>
  </ul>
 </div>
</template>
