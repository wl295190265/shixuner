<template lang="html">
  <div class="cart-detail">
    ...
    <ul class="groups" :class="hasProduct?'':'isHidden'">
      <div class="g-header">
        <span class="check-icon" @click="checkAll()">
      ...
      <li class="group" v-for="(item, index) in cartLists" :key="index">
        <span class="check-icon" @click="checkOne(item,index)">
          <img :src="arr[index]?checkIcon:checkNotIcon" alt="">
        </span>
