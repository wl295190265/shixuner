		...
		<div id="datePage" class="page">
			<section>
	            ...
	            <div id="datescroll">
	            	<div id="yearwrapper">
	            		<ul>
	            			<li v-for="item in primaryScrollerData">{{item}}</li>
	            		</ul>
	            	</div>
	            	<div id="monthwrapper">
		            	<ul>
		            		<li v-for="item in secondryScrollerData">{{item}}</li>
		            	</ul>
		            </div>
	            	<div id="daywrapper">
	            		<ul>
	            			<li v-for="item in tertiaryScrollerData">{{item}}</li>
	            		</ul>
	            	</div>
	            </div>
	        </section>
...
<script>
	...
	export default {
		...
		methods: {
            ...
            showScrollSelector(event) {
                this.init_iScrll(); //初始化iscrll
                this.extendOptions(); //显示控件
                $(event.target).blur();
            ...
            initScrollContain(options, Ycallback, Ncallback) {
