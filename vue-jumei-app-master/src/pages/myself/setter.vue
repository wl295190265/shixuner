<template lang="html">
  <transition name="fade">
    <div class="set-wrapper" ref="setWrapper">
      ...
      <div class="block b1">
        <mt-cell title="个人资料" is-link to="http://localhost:8091/#/userinfo" class="underline"></mt-cell>
        <mt-cell title="账号绑定"></mt-cell>
      </div>
      <div class="block b2">
        <mt-cell title="收货地址管理" class="underline" is-link to="http://localhost:8091/#/address"></mt-cell>
