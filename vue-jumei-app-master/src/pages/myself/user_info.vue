<template>
    ...
    <div class="user_info_main">
		...
		<div @click="save()"  style="float: right; margin-right: 10px ;margin-top: 15px;">
				保存
		</div>
		...
		<div  >
            ...
            <div class="info_item">
                ...
                <input type="email" class="info_input" v-model="userInfo.Email" placeholder="键入邮箱进行绑定" @blur="saveEmail">
            </div>
            <div class="info_item">
            ...
            <div class="info_item">
                ...
                <div class="bind_phone_box">
                    ...
                    <span class="bind_phone_tip" v-else @click="bindPhoneHanlde">修改绑定</span>
                </div>
            </div>
            <div class="info_item">
    ...
    export default {
        ...
        methods: {
			getUserInfo(){
				...
				console.log(JSON.parse(storage["userInfo"]))
...
<style scoped="scoped">
    ...
    .wechat_icon {
        ...
        width: 16px;
        height: 16px;
        background: url('../../images/user_info/wechat_icon.png') center no-repeat;
        background-size: 100% auto;
    }
